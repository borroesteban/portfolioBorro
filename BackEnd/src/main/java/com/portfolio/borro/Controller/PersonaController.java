...
import com.portfolio.borro.Dto.dtoPersona;
import com.portfolio.borro.Entity.Persona;
import com.portfolio.borro.Security.Controller.Mensaje;
import com.portfolio.borro.Service.ImpPersonaService;
...
@Autowired
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoPersona dtopersona){
        ...
        if(StringUtils.isBlank(dtopersona.getNombre())){
            return new ResponseEntity(new Mensaje("error: campo vacío"), HttpStatus.BAD_REQUEST);
        }
        ...
        return new ResponseEntity(new Mensaje("actualización correcta"), HttpStatus.OK);
